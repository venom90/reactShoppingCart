...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EditModal = __webpack_require__(235);

	var _EditModal2 = _interopRequireDefault(_EditModal);

	var _cta = __webpack_require__(237);

	var _cta2 = _interopRequireDefault(_cta);

	var _lock = __webpack_require__(238);
	...
	var Cart = function (_Component) {
	    ...
	    _createClass(Cart, [{
	        ...
	        key: 'remove',
	        value: function remove(id, evt) {
	            evt.preventDefault();
	        }
	    }, {
	        key: 'saveForLater',
	        value: function saveForLater(id, evt) {
	            evt.preventDefault();
	        }
	    }, {
	        key: 'submitBlank',
	        value: function submitBlank(evt) {
	            evt.preventDefault();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                this.props.SingleProduct && _react2.default.createElement(_EditModal2.default, { close: this.modalClose, data: this.props.SingleProduct, show: this.props.SingleProduct && this.state.showEditModal }),
	                _react2.default.createElement(
	                    'table',
	                    { className: 'table' },
	                    _react2.default.createElement(
	                            ...
	                            return _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'col-md-3' },
	                                        _react2.default.createElement('img', { src: product.p_img })
	                                    ),
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'col-md-9' },
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            null,
	                                            'Color: ',
	                                            product.p_selected_color.name
	                                        ),
	                                        _react2.default.createElement(
	                                            'div',
	                                            { className: 'posRel cartRow' },
	                                            _react2.default.createElement(
	                                                'ul',
	                                                { className: 'cartItemNav' },
	                                                _react2.default.createElement(
	                                                    'li',
	                                                    null,
	                                                    _react2.default.createElement(
	                                                        'a',
	                                                        { href: '#', onClick: _this2.edit.bind(_this2, product.id) },
	                                                        'EDIT'
	                                                    )
	                                                ),
	                                                _react2.default.createElement(
	                                                    ...
	                                                    _react2.default.createElement(
	                                                        'a',
	                                                        { href: '#', onClick: _this2.remove.bind(_this2, product.id) },
	                                                        'X REMOVE'
	                                                    )
	                                                ),
	                                                _react2.default.createElement(
	                                                    ...
	                                                    _react2.default.createElement(
	                                                        'a',
	                                                        { href: '#', onClick: _this2.saveForLater.bind(_this2, product.id) },
	                                                        'SAVE FOR LATER'
	                                                    )
	                                                )
	                                            )
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { style: { width: 20 }, type: 'text', defaultValue: product.p_quantity })
	                                ),
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'col-md-4' },
	                                'ENTER PROMOTION CODE OR GIFT CODE'
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'col-md-8' },
	                                _react2.default.createElement(
	                                    'form',
	                                    { onSubmit: this.submitBlank, className: 'promo taR' },
	                                    _react2.default.createElement('input', { type: 'text' }),
	                                    _react2.default.createElement(
	                                        'button',
	                                        { type: 'submit', className: 'btn btn-basic' },
	                                        'APPLY'
	                                    )
	                                )
	                            )
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'p',
	                                { className: 'grey' },
	                                _react2.default.createElement('img', { src: _lock2.default, alt: '' }),
	...
	function mapStateToProps(_ref) {
	    ...
	    return { products: products, SingleProduct: SingleProduct };
	}

	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ fetchProductsInCart: _index.fetchProductsInCart, fetchProductsInCartById: _index.fetchProductsInCartById }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.EDIT_PRODUCT = exports.FETCH_ALL_PRODUCTS = exports.FETCH_PRODUCTS_IN_CART_BY_ID = undefined;
	exports.fetchProductsInCart = fetchProductsInCart;
	exports.fetchProductsInCartById = fetchProductsInCartById;
	...
	var ROOT_URL = 'https://reactshoppingcartdatasapient.herokuapp.com/productsInCart';

	var FETCH_PRODUCTS_IN_CART_BY_ID = exports.FETCH_PRODUCTS_IN_CART_BY_ID = 'FETCH_PRODUCTS_IN_CART_BY_ID';
	var FETCH_ALL_PRODUCTS = exports.FETCH_ALL_PRODUCTS = 'FETCH_ALL_PRODUCTS';
	...
	function fetchProductsInCartById(id) {
	    var url = ROOT_URL + '/' + id;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EditModal = function (_Component) {
	    ...
	    _createClass(EditModal, [{
	        ...
	        key: 'submit',
	        value: function submit(id, evt) {
	            this.props.editProduct.call(this, id, this.finalObject);
	            this.close();
	        }
	    }, {
	        key: 'changeColor',
	        value: function changeColor(hexcode, evt) {}
	    }, {
	        key: 'render',
	        value: function render() {
	            var _this2 = this;

	            var _d = this.finalObject = this.props.data;
	            var pName = this.props.data.p_selected_color && this.props.data.p_selected_color.name;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-md-6 edit-control' },
	                        _react2.default.createElement(
	                            'h3',
	                            { className: 'robotoSlab allCap taC' },
	                            _d.p_name
	                        ),
	                        _react2.default.createElement(
	                            'p',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'h4',
	                                { className: 'allCap taC' },
	                                pName
	                            ),
	                            _react2.default.createElement(
	                                'ul',
	                                null,
	                                _d.p_available_options && _d.p_available_options.colors.map(function (color) {
	                                    return _react2.default.createElement('li', { onClick: _this2.changeColor.bind(_this2, color.hexcode), style: { backgroundColor: color.hexcode } });
	                                })
	                            )
	                        ),
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _d.p_available_options && _d.p_available_options.sizes.map(function (size) {
	                                    return _react2.default.createElement(
	                                        'option',
	                                        null,
	                                        size.name
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn btn-primary taC', onClick: this.submit.bind(this, this.props.data.id) },
	                            'EDIT'
	                        ),
	                        _react2.default.createElement(
	                            'p',
	                            { className: 'tu grey' },
	                            'Seer product details'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-md-6 image-holder' },
	                        _react2.default.createElement('img', { src: _d.p_img, alt: '' })
	                    )
	                )
	            );
	        }
	...
	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ editProduct: _index.editProduct }, dispatch);
	}
	...
	var Modal = function (_Component) {
	    ...
	    _createClass(Modal, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "modal", role: "dialog", style: this.props.show ? { display: 'block' } : { display: 'none' } },
	                _react2.default.createElement(
	                    "div",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "ea9a41cddb8e48de9881041b1b0c919a.jpg";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_products = __webpack_require__(240);

	var _reducer_products2 = _interopRequireDefault(_reducer_products);

	var _reducer_singleProduct = __webpack_require__(241);

	var _reducer_singleProduct2 = _interopRequireDefault(_reducer_singleProduct);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	    products: _reducer_products2.default,
	    SingleProduct: _reducer_singleProduct2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _index.FETCH_ALL_PRODUCTS:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _index.FETCH_PRODUCTS_IN_CART_BY_ID:
	            return action.payload.data;
	    }
	    return state;
	};
